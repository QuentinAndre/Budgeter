Qualtrics.SurveyEngine.addOnload(function () {
    ...
    var FUND_TYPE = "${e://Field/FUND_TYPE}"; //
    var FUND_AMOUNT = "${e://Field/FUND_AMOUNT}";
    var MIN_SPEND = "${e://Field/MIN_SPEND}";
    ...
    function setUpPage() { // Create the objects on the page, and display the constants.
        ...
        /* Hiding the default Qualtrics "Next" Button */
        $j("#NextButton").hide();
    ...
    function submitBudget() { // Store the data and proceed to next page
        var enddate = new Date();
        taskduration = (enddate.getTime() - startdate.getTime());

        Qualtrics.SurveyEngine.setEmbeddedData("FoodValue", foodvalue);
        Qualtrics.SurveyEngine.setEmbeddedData("TransportValue", transvalue);
        Qualtrics.SurveyEngine.setEmbeddedData("LeisureValue", leisvalue);
        Qualtrics.SurveyEngine.setEmbeddedData("FoodHistory", food_hist.join("*"));
        Qualtrics.SurveyEngine.setEmbeddedData("TransportHistory", transport_hist.join("*"));
        Qualtrics.SurveyEngine.setEmbeddedData("LeisureHistory", leisure_hist.join("*"));
        Qualtrics.SurveyEngine.setEmbeddedData("FoodClicks", foodclicks);
        Qualtrics.SurveyEngine.setEmbeddedData("TransportClicks", transportclicks);
        Qualtrics.SurveyEngine.setEmbeddedData("LeisureClicks", leisureclicks);
        Qualtrics.SurveyEngine.setEmbeddedData("TaskDuration", taskduration);
        $j("#NextButton").click();
    }
